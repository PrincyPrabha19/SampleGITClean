...
namespace ManagedCustomActions
{
    ...
    public class CustomAction
    {
        ...
        private void SendMessage(OverallInstallationStatus status, int progress, int progress_next, string message)
        {
        ...
        public UInt32 OnBegin(object pDispatch)
        {
            ...
            try
            {
                ...
                SendMessage(OverallInstallationStatus.Launch, progress, progress_next, msg);
        ...
        public UInt32 OnStaging(object pDispatch)
        {
            ...
            try
            {
                ...
                SendMessage(OverallInstallationStatus.Updating, progress, progress_next, msg);
            }
            catch (System.ContextMarshalException)
            {
        ...
        private bool IsPackageSigned(ISuiteExtension suiteExtension)
        {
            ...
            string downloadpath = System.IO.Path.Combine(localappfolder, @"Downloaded Installations");
        ...
        public UInt32 OnStaged(object pDispatch)
        {
            ...
            try
            {
                ...
                if (false == IsPackageSigned(suiteExtension))
                {
                    ...
                    SendMessage(OverallInstallationStatus.Updating, progress, progress_next, ms);
                    return ERROR_INSTALL_FAILURE;
                }
                suiteExtension.LogInfo("Percentage = " + progress.ToString());
        ...
        public UInt32 OnAWCC_Package_Configured(object pDispatch)
        {
            ...
            try
            {
                ...
                System.IO.File.Copy(support_uninstall_path, uninstallpath);
                ...
                System.IO.File.Copy(support_repair_path, repair_path);
        ...
        public UInt32 OnEnd(object pDispatch)
        {
            ...
            try
            {
                ...
                SendMessage(OverallInstallationStatus.Completed, progress, progress_next, msg);
